    ...
    <div class="card">
        <div class="card-header header-elements-inline s-filter">
            <div class="col-sm-6 mb-1" align="left">
                <h6 class="card-title"><b>PROPERTY DETAILS</b></h6>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" class="form-control" id="phone" value="{{$data->phone ?? ''}}" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="address">Address</label>
                            <input type="text" name="address" class="form-control" id="address" value="{{$data->address ?? ''}}" disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="address">Primary Image</label>
                            <img src="{{ $data->primary_image }}" alt="img" height="100px" width="200px">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="address">Secondary Images</label>
                            @if(isset($data->secondary_images) && is_array(json_decode($data->secondary_images)))
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control" id="description" value="{{$data->description ?? ''}}" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="bedroom">Bedroom</label>
                            <input type="text" name="bedroom" class="form-control" id="bedroom" value="{{$data->bedroom ?? '0'}}" disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="bathroom" class="form-control" id="bathroom" value="{{$data->bathroom ?? '0'}}" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label >Outdoor Area</label>
                            <input type="text" name="outdoor_area" class="form-control" id="outdoor_area" value="{{$data->outdoor_area ?? '0'}}" disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="net_area" class="form-control" id="net_area" value="{{$data->net_area ?? '0'}}" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label >Gross Area</label>
                            <input type="text" name="gross_area" class="form-control" id="gross_area" value="{{$data->gross_area ?? '0'}}" disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label >Price</label>
                            <input type="text" name="price" class="form-control" id="price" value="{{$data->price ?? '0'}}" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
    <div class="form-group">
        ...
        <select class="form-control chosen-select" multiple id="amenities" name="amenities[]" disabled>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="capacity" class="form-control" id="capacity" value="{{$data->capacity ?? ''}}" disabled>
                        </div>
                    </div>
                </div>
