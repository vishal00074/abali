...
<div class="content">
    <div class="card">
        <div class ="card-header header-elements-inline s-filter">
            <div class="col-md-6">
                <h6 class="card-title"><b>Landholders  List</b></h6></div>
        ...
        <table class="table get_landholder_list">
            <thead>
                <tr>
                    <th>S.No.</th>
                    <th>Name</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // init datatable.
        var dataTable = $('.get_landholder_list').DataTable({
            processing: true,
            serverSide: true,
            autoWidth: false,
            //pageLength: 5,
            scrollX: true,
            "order": [[ 0, "desc" ]],
            ajax: "{{ url('/admin/get_landholder_list') }}",
            columns: [
