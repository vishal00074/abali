...
<div class="content">
    <div class="card">
        <div class ="card-header header-elements-inline s-filter">
            <div class="col-md-6">
                <h6 class="card-title"><b>Property  List</b></h6></div>
                <!-- <a href="">
                   <button type="button" class="btn btn-primary btn-sm" ><i class="icon-plus-circle2 mr-2"></i> Add</button>
                </a> -->
                <div class="col-md-6 text-right">
                    <a href="{{ url('/admin/add_property') }}" class="btn btn-primary" > <i class="icon-circle-left2 mr-1"></i> Add</a>
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('.get_user_list').DataTable({
            ...
            columns: [
                ...
                {data: 'formatted_check_in', name: 'formatted_check_in'},
                {data: 'formatted_check_out', name: 'formatted_check_out'},
